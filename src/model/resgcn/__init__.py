# Vendored from GaitGraph (MIT, see LICENSE in this folder):
#   https://github.com/tteepe/GaitGraph/tree/main/src/models/ResGCNv1
# which itself adapts ResGCNv1 (https://github.com/yfsong0709/ResGCNv1).
# Only change: modules.py resolves blocks by getattr instead of a
# hard-coded "models.ResGCNv1" import path. The forward pass GaitGraph2
# used lives in src/model/gait_model.py, so nets.py is untouched.
